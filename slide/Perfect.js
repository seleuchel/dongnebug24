...
import { Platform, Text, View, Button, StyleSheet,WebView } from 'react-native';
  ...
  render() {
    ...
    return (
      ...
      <WebView style={styles.web}
        ...
        <Button title='내 위치' color="red" onPress={() => this._panel.show()} />
                <SlidingUpPanel ref={c => this._panel = c} >
                  <View style={{flex:0.7, top:300}}>
                    <Button title='숨기기' color="red" onPress={() => this._panel.hide()} />
                      <MapView
                        style={styles.map}
                        initialRegion ={{
                            latitude: lat,
